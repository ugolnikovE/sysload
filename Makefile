...
clean:
	rm -f $(SYSLOAD_OBJ) $(SYSLOAD_STATIC) $(SYSLOAD_SHARED) $(EXAMPLE_OBJ) $(EXAMPLE_EXEC)
...
.PHONY: all example run-example install install-static install-shared uninstall clean
